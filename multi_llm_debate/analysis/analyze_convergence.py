...
import pandas as pd
def analyze_round_number(base_dir: Path, max_round_number: int, output_csv: Path) -> None:
    """
    ...
    column_order = ["model_configuration"] + [str(i) for i in range(1, max_round_number + 1)]
