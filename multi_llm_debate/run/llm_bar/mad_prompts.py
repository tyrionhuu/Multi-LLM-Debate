...
# JSON format for LLM Bar MAD responses
JSON_FORMAT = """
{
...
def build_llm_bar_mad_player_meta_prompt(debate_topic: str) -> str:
    """Build meta prompt for LLM Bar MAD debate players.
...
def build_llm_bar_mad_moderator_meta_prompt(debate_topic: str) -> str:
    """Build meta prompt for LLM Bar MAD debate moderator.
...
def build_llm_bar_mad_affirmative_prompt(debate_topic: str) -> str:
    """Build affirmative prompt for LLM Bar MAD debate.
    ...
    prompt += "**IMPORTANT:** You must choose between 'Response 1' and 'Response 2' and provide clear reasoning for your choice."

    return prompt


def build_llm_bar_mad_negative_prompt(aff_ans: str) -> str:
    """Build negative prompt for LLM Bar MAD debate.
...
def build_llm_bar_mad_moderator_prompt(aff_ans: str, neg_ans: str, round_name: str) -> str:
    """Build moderator prompt for LLM Bar MAD debate.
...
def build_llm_bar_mad_judge_prompt_1(aff_ans: str, neg_ans: str) -> str:
    """Build first judge prompt for LLM Bar MAD debate.
...
def build_llm_bar_mad_judge_prompt_2(debate_topic: str) -> str:
    """Build second judge prompt for LLM Bar MAD debate.
...
def build_llm_bar_mad_debate_prompt(oppo_ans: str) -> str:
    """Build debate prompt for LLM Bar MAD debate.
...
def build_llm_bar_mad_prompts(debate_topic: str) -> Dict[str, str]:
    ...
    Returns:
        Dict containing all MAD prompts for LLM Bar
    """
    return {
        ...
        "negative_prompt": build_llm_bar_mad_negative_prompt("##aff_ans##"),  # Placeholder
        "moderator_prompt": build_llm_bar_mad_moderator_prompt("##aff_ans##", "##neg_ans##", "##round##"),  # Placeholders
        "judge_prompt_last1": build_llm_bar_mad_judge_prompt_1("##aff_ans##", "##neg_ans##"),  # Placeholders
