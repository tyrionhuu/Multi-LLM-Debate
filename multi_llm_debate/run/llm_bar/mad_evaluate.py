...
def analyze_mad_response_for_llm_bar(mad_answer: str, correct_answer: str) -> Dict[str, Any]:
    ...
    # Try to extract "1" or "2" from MAD answer
    mad_choice = None
    if "response 1" in mad_answer or "response1" in mad_answer or "1" in mad_answer:
        mad_choice = "1"
    elif "response 2" in mad_answer or "response2" in mad_answer or "2" in mad_answer:
        mad_choice = "2"
