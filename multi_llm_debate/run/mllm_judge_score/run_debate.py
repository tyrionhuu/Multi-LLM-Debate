...
from .prompts import (
    build_mllm_judge_score_round_n_prompt,
    build_mllm_judge_score_round_zero_prompt,
)
from .utils import extract_1_5_answer, image_str_to_bytes
...
def process_mllm_judge_score_dataset(
    ...
    max_rounds: int = 10,
    base_dir: Path = Path("data") / "mllm_judge_score",
...
def process_mllm_judge_score_entry(
    ...
    process_single_debate_entry(
        ...
        prompt_builder_fn=lambda prompt_params: PromptBuilder(
            round_zero_fn=build_mllm_judge_score_round_zero_prompt,
            round_n_fn=build_mllm_judge_score_round_n_prompt,
            prompt_params=prompt_params,
            query=entry["question"],
            images=image_str_to_bytes(entry["image"]),
        ),
        prompt_params={
