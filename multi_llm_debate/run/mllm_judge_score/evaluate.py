...
from .utils import compare_mllm_judge_score_response, extract_1_5_answer

def evaluate_mllm_judge_score_responses(
    responses: List[Dict],
    answer: str,
) -> bool:
    ...
    """
    return all(
        compare_mllm_judge_score_response(
...
def evaluate_all_mllm_judge_score(
    ...
    return evaluate_all(
        ...
        evaluation_func=evaluate_mllm_judge_score_responses,
    )