...
def build_mllm_judge_pair_mad_moderator_prompt(aff_ans: str, neg_ans: str, round_name: str) -> str:
...
def build_mllm_judge_pair_mad_prompts(debate_topic: str) -> Dict[str, str]:
    ...
    return {
        ...
        "moderator_meta_prompt": build_mllm_judge_pair_mad_moderator_meta_prompt(debate_topic),
        "affirmative_prompt": build_mllm_judge_pair_mad_affirmative_prompt(debate_topic),
        "negative_prompt": build_mllm_judge_pair_mad_negative_prompt("##aff_ans##"),  # Placeholder
        "moderator_prompt": build_mllm_judge_pair_mad_moderator_prompt("##aff_ans##", "##neg_ans##", "##round##"),  # Placeholders
        "judge_prompt_last1": build_mllm_judge_pair_mad_judge_prompt_1("##aff_ans##", "##neg_ans##"),  # Placeholders
        "judge_prompt_last2": build_mllm_judge_pair_mad_judge_prompt_2(debate_topic),
        "debate_prompt": build_mllm_judge_pair_mad_debate_prompt("##oppo_ans##"),  # Placeholder
    } 