...
class DebatePlayer(Agent):
    def __init__(
        ...
        """
        super(DebatePlayer, self).__init__(model_name, name, temperature, provider, sleep_time)
...
class Debate:
    def __init__(self,
        ...
        Args:
            ...
            config (dict): Configuration for the debate
    ...
    def creat_agents(self):
        # creates players
        self.players = [
            DebatePlayer(model_name=self.model_name, name=name, temperature=self.temperature, provider=self.provider, sleep_time=self.sleep_time) for name in NAME_LIST
        ]
    ...
    def run(self):
        ...
        # ultimate deadly technique.
            ...
            judge_player = DebatePlayer(model_name=self.model_name, name='Judge', temperature=self.temperature, provider=self.provider, sleep_time=self.sleep_time)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        debate = Debate(num_players=3, provider="ollama", config=config, temperature=0, sleep_time=0)
        debate.run()