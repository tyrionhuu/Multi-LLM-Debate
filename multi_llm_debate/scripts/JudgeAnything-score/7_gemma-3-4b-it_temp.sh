...
CUDA_VISIBLE_DEVICES=all python -m multi_llm_debate.run.judge_anything_score.main \
    --config-json "$CONFIG" \
    --task-name "judge_anything_score_temp_0_6" \
    --batch \
    --batch-size 11 \
    --sample-size 1000 \
    --temperature 0.6 \
...
CUDA_VISIBLE_DEVICES=all python -m multi_llm_debate.run.judge_anything_score.main \
    --config-json "$CONFIG" \
    --task-name "judge_anything_score_temp_0_8" \
    --batch \
    --batch-size 11 \
    --sample-size 1000 \
    --temperature 0.8 \
...
CUDA_VISIBLE_DEVICES=all python -m multi_llm_debate.run.judge_anything_score.main \
    --config-json "$CONFIG" \
    --task-name "judge_anything_score_temp_1_2" \
    --batch \
    --batch-size 11 \
    --sample-size 1000 \
    --temperature 1.2 \
...
CUDA_VISIBLE_DEVICES=all python -m multi_llm_debate.run.judge_anything_score.main \
    --config-json "$CONFIG" \
    --task-name "judge_anything_score_temp_1_4" \
    --batch \
    --batch-size 11 \
    --sample-size 1000 \
    --temperature 1.4 \
